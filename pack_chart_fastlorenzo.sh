...
rm -rf gh-pages
git clone --single-branch --branch gh-pages https://github.com/fastlorenzo/helm-charts-1.git gh-pages
( cd gh-pages && git remote set-url origin git@github.com:fastlorenzo/helm-charts-1.git)

echo "Packing helm chart"
${HELM} package mailu -d gh-pages
echo "Updating repo index"
${HELM} repo index --url https://fastlorenzo.github.io/helm-charts-1/ gh-pages
